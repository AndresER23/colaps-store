...
export const metadata = {
  title: "Colaps Hogar — Todo para tu hogar con envío gratis",
  description: "Productos para el hogar. Envío gratis, pago contraentrega y garantía de 30 días.",
};
        ...
        {products.length === 0 ? (
          ...
          <div className="grid grid-cols-3 gap-5">
            {products.map((product) => (
              <ProductCard key={product.id} product={product} categorySlug="hogar" />
            ))}
          </div>
        )}
      </section>
