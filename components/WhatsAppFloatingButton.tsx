...
interface WhatsAppButtonProps {
    phoneNumber: string; // Formato: 573001234567 (código país + número)
...
export function WhatsAppFloatingButton({
    ...
    return (
        ...
        >
            ...
            {/* Tooltip */}
            <div className="absolute bottom-full right-0 mb-3 px-4 py-2 rounded-lg text-xs font-semibold text-white whitespace-nowrap opacity-0 group-hover:opacity-100 transition-opacity pointer-events-none"
                style={{
